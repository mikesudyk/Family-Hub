...
export const INITIAL_CHORES = {
  3: [ // Elijah
    { id: 1,  name: "Take out trash",     icon: "🗑️", time: "Morning",   done: false, fixed: true  },
    { id: 2,  name: "Vacuum living room", icon: "🧹", time: "Afternoon", done: false, fixed: true  },
  ...
  4: [ // Alyssandra
    { id: 5,  name: "Sweep kitchen",  icon: "🧹", time: "Morning",   done: false, fixed: true  },
    { id: 6,  name: "Clean bathroom", icon: "🚿", time: "Morning",   done: false, fixed: true  },
    { id: 7,  name: "Feed dog",       icon: "🐕", time: "Morning",   done: false, fixed: true  },
    { id: 8,  name: "Fold laundry",   icon: "👕", time: "Afternoon", done: false, fixed: false },
  ],
  5: [ // Emori
    { id: 9,  name: "Make bed",     icon: "🛏️", time: "Morning",   done: false, fixed: true },
    { id: 10, name: "Pick up toys", icon: "🧸", time: "Afternoon", done: false, fixed: true },
    { id: 11, name: "Feed fish",    icon: "🐟", time: "Morning",   done: false, fixed: true },
  ],
  6: [ // Malachi
    { id: 12, name: "Make bed",     icon: "🛏️", time: "Morning",   done: false, fixed: true },
  ...
  7: [ // Roman
    { id: 15, name: "Make bed",      icon: "🛏️", time: "Morning", done: false, fixed: true },
